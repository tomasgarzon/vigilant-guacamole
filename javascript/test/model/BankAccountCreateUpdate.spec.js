...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NucoroApi.BankAccountCreateUpdate();
  });
  ...
  describe('BankAccountCreateUpdate', function() {
    it('should create an instance of BankAccountCreateUpdate', function() {
      // uncomment below and update the code to test BankAccountCreateUpdate
      //var instance = new NucoroApi.BankAccountCreateUpdate();
      //expect(instance).to.be.a(NucoroApi.BankAccountCreateUpdate);
    });
