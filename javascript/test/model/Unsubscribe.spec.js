...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NucoroApi.Unsubscribe();
  });
  ...
  describe('Unsubscribe', function() {
    it('should create an instance of Unsubscribe', function() {
      // uncomment below and update the code to test Unsubscribe
      //var instance = new NucoroApi.Unsubscribe();
      //expect(instance).to.be.a(NucoroApi.Unsubscribe);
    });
