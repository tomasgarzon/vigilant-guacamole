...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NucoroApi.PatchedAddressUpdate();
  });
  ...
  describe('PatchedAddressUpdate', function() {
    it('should create an instance of PatchedAddressUpdate', function() {
      // uncomment below and update the code to test PatchedAddressUpdate
      //var instance = new NucoroApi.PatchedAddressUpdate();
      //expect(instance).to.be.a(NucoroApi.PatchedAddressUpdate);
    });
