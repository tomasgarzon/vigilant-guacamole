...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NucoroApi.PortfolioUpdate();
  });
  ...
  describe('PortfolioUpdate', function() {
    it('should create an instance of PortfolioUpdate', function() {
      // uncomment below and update the code to test PortfolioUpdate
      //var instance = new NucoroApi.PortfolioUpdate();
      //expect(instance).to.be.a(NucoroApi.PortfolioUpdate);
    });
