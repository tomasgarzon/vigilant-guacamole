...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NucoroApi.InvoiceList();
  });
  ...
  describe('InvoiceList', function() {
    it('should create an instance of InvoiceList', function() {
      // uncomment below and update the code to test InvoiceList
      //var instance = new NucoroApi.InvoiceList();
      //expect(instance).to.be.a(NucoroApi.InvoiceList);
    });
