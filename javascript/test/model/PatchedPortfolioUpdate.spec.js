...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NucoroApi.PatchedPortfolioUpdate();
  });
  ...
  describe('PatchedPortfolioUpdate', function() {
    it('should create an instance of PatchedPortfolioUpdate', function() {
      // uncomment below and update the code to test PatchedPortfolioUpdate
      //var instance = new NucoroApi.PatchedPortfolioUpdate();
      //expect(instance).to.be.a(NucoroApi.PatchedPortfolioUpdate);
    });
