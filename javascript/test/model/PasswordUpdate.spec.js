...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NucoroApi.PasswordUpdate();
  });
  ...
  describe('PasswordUpdate', function() {
    it('should create an instance of PasswordUpdate', function() {
      // uncomment below and update the code to test PasswordUpdate
      //var instance = new NucoroApi.PasswordUpdate();
      //expect(instance).to.be.a(NucoroApi.PasswordUpdate);
    });
