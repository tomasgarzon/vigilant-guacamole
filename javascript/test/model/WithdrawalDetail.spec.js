...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NucoroApi.WithdrawalDetail();
  });
  ...
  describe('WithdrawalDetail', function() {
    it('should create an instance of WithdrawalDetail', function() {
      // uncomment below and update the code to test WithdrawalDetail
      //var instance = new NucoroApi.WithdrawalDetail();
      //expect(instance).to.be.a(NucoroApi.WithdrawalDetail);
    });
