...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NucoroApi.PatchedGoal();
  });
  ...
  describe('PatchedGoal', function() {
    it('should create an instance of PatchedGoal', function() {
      // uncomment below and update the code to test PatchedGoal
      //var instance = new NucoroApi.PatchedGoal();
      //expect(instance).to.be.a(NucoroApi.PatchedGoal);
    });
