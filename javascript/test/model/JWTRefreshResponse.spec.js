...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NucoroApi.JWTRefreshResponse();
  });
  ...
  describe('JWTRefreshResponse', function() {
    it('should create an instance of JWTRefreshResponse', function() {
      // uncomment below and update the code to test JWTRefreshResponse
      //var instance = new NucoroApi.JWTRefreshResponse();
      //expect(instance).to.be.a(NucoroApi.JWTRefreshResponse);
    });
