...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NucoroApi.AddressUpdate();
  });
  ...
  describe('AddressUpdate', function() {
    it('should create an instance of AddressUpdate', function() {
      // uncomment below and update the code to test AddressUpdate
      //var instance = new NucoroApi.AddressUpdate();
      //expect(instance).to.be.a(NucoroApi.AddressUpdate);
    });
