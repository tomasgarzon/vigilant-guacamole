...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NucoroApi.PortfolioDetail();
  });
  ...
  describe('PortfolioDetail', function() {
    it('should create an instance of PortfolioDetail', function() {
      // uncomment below and update the code to test PortfolioDetail
      //var instance = new NucoroApi.PortfolioDetail();
      //expect(instance).to.be.a(NucoroApi.PortfolioDetail);
    });
    ...
    it('should have the property depositReference (base name: "deposit_reference")', function() {
      // uncomment below and update the code to test the property depositReference
      //var instance = new NucoroApi.PortfolioDetail();
      //expect(instance).to.be();
    });
