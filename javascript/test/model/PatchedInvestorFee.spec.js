...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NucoroApi.PatchedInvestorFee();
  });
  ...
  describe('PatchedInvestorFee', function() {
    it('should create an instance of PatchedInvestorFee', function() {
      // uncomment below and update the code to test PatchedInvestorFee
      //var instance = new NucoroApi.PatchedInvestorFee();
      //expect(instance).to.be.a(NucoroApi.PatchedInvestorFee);
    });
