...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NucoroApi.AddressList();
  });
  ...
  describe('AddressList', function() {
    it('should create an instance of AddressList', function() {
      // uncomment below and update the code to test AddressList
      //var instance = new NucoroApi.AddressList();
      //expect(instance).to.be.a(NucoroApi.AddressList);
    });
