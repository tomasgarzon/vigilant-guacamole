...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NucoroApi.ApplicationClientUpdate();
  });
  ...
  describe('ApplicationClientUpdate', function() {
    it('should create an instance of ApplicationClientUpdate', function() {
      // uncomment below and update the code to test ApplicationClientUpdate
      //var instance = new NucoroApi.ApplicationClientUpdate();
      //expect(instance).to.be.a(NucoroApi.ApplicationClientUpdate);
    });
