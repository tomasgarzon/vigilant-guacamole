...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NucoroApi.PatchedApplicationClientUpdate();
  });
  ...
  describe('PatchedApplicationClientUpdate', function() {
    it('should create an instance of PatchedApplicationClientUpdate', function() {
      // uncomment below and update the code to test PatchedApplicationClientUpdate
      //var instance = new NucoroApi.PatchedApplicationClientUpdate();
      //expect(instance).to.be.a(NucoroApi.PatchedApplicationClientUpdate);
    });
    ...
    it('should have the property emailVerifiedLastRequest (base name: "email_verified_last_request")', function() {
      // uncomment below and update the code to test the property emailVerifiedLastRequest
      //var instance = new NucoroApi.PatchedApplicationClientUpdate();
      //expect(instance).to.be();
    });
