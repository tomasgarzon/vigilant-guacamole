...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NucoroApi.AllocationDetail();
  });
  ...
  describe('AllocationDetail', function() {
    it('should create an instance of AllocationDetail', function() {
      // uncomment below and update the code to test AllocationDetail
      //var instance = new NucoroApi.AllocationDetail();
      //expect(instance).to.be.a(NucoroApi.AllocationDetail);
    });
