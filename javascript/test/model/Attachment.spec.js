...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NucoroApi.Attachment();
  });
  ...
  describe('Attachment', function() {
    it('should create an instance of Attachment', function() {
      ...
      //var instance = new NucoroApi.Attachment();
      //expect(instance).to.be.a(NucoroApi.Attachment);
    });

    it('should have the property attachmentExtension (base name: "attachment_extension")', function() {
      // uncomment below and update the code to test the property attachmentExtension
      //var instance = new NucoroApi.Attachment();
