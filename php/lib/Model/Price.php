...
class Price implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount > 1000000000000)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling Price., must be smaller than or equal to 1000000000000.');
        }
        if (($amount < -1000000000000)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling Price., must be bigger than or equal to -1000000000000.');
        }
