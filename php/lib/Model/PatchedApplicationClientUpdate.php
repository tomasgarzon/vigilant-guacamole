...
/**
 * PatchedApplicationClientUpdate Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedApplicationClientUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedApplicationClientUpdate';
    ...
    protected static $openAPITypes = [
        ...
        'password' => 'string',
        'email_verified_last_request' => '\DateTime',
        'uuid' => 'string',
        'created' => '\DateTime',
        'updated' => '\DateTime',
        'comments' => 'string',
    ...
    protected static $openAPIFormats = [
        ...
        'password' => null,
        'email_verified_last_request' => 'date-time',
        'uuid' => 'uuid',
        'created' => 'date-time',
        'updated' => 'date-time',
        'comments' => null,
    ...
    protected static $setters = [
        ...
        'email_verified_last_request' => 'setEmailVerifiedLastRequest',
        'uuid' => 'setUuid',
        'created' => 'setCreated',
        'updated' => 'setUpdated',
    ...
    protected static $getters = [
        ...
        'email_verified_last_request' => 'getEmailVerifiedLastRequest',
        'uuid' => 'getUuid',
        'created' => 'getCreated',
        'updated' => 'getUpdated',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['email_verified_last_request'] = $data['email_verified_last_request'] ?? null;
     ...
     *
     * @param \DateTime|null $tos_consent_date tos_consent_date
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $tax_information tax_information
     *
     * @return self
     */
     ...
     * Gets country_birth
     *
     * @return \OpenAPI\Client\Model\CountryField|null
     */
     ...
     * Sets country_birth
     *
     * @param \OpenAPI\Client\Model\CountryField|null $country_birth country_birth
     *
     * @return self
     */
     ...
     *
     * @param int|null $successful_referrals successful_referrals
     *
     * @return self
     */
     ...
     * Sets kyc_verified
     *
     * @param bool|null $kyc_verified kyc_verified
     *
     * @return self
     */
     ...
     * Sets fee_segments
     *
     * @param string[]|null $fee_segments fee_segments
     *
     * @return self
     */
     ...
     * Sets portfolios
     *
     * @param string[]|null $portfolios portfolios
     *
     * @return self
     */
     ...
     *
     * @param string|null $onboarding_token onboarding_token
     *
     * @return self
     */
    ...
    /**
     * Gets email_verified_last_request
     *
     * @return \DateTime|null
     */
    public function getEmailVerifiedLastRequest()
    {
        return $this->container['email_verified_last_request'];
    }

    /**
     * Sets email_verified_last_request
     *
     * @param \DateTime|null $email_verified_last_request email_verified_last_request
     *
     * @return self
     */
    public function setEmailVerifiedLastRequest($email_verified_last_request)
    {
        $this->container['email_verified_last_request'] = $email_verified_last_request;
     ...
     * Sets status
     *
     * @param StatusB65Enum|null $status status
     *
     * @return self
     */
    ...
    public function setLanguage($language)
    {
        if (!is_null($language) && (mb_strlen($language) > 5)) {
            throw new \InvalidArgumentException('invalid length for $language when calling PatchedApplicationClientUpdate., must be smaller than or equal to 5.');
        }
    ...
    public function setProfession($profession)
    {
        if (!is_null($profession) && (mb_strlen($profession) > 250)) {
            throw new \InvalidArgumentException('invalid length for $profession when calling PatchedApplicationClientUpdate., must be smaller than or equal to 250.');
        }
    ...
    public function setReferralCode($referral_code)
    {
        if (!is_null($referral_code) && (mb_strlen($referral_code) > 250)) {
            throw new \InvalidArgumentException('invalid length for $referral_code when calling PatchedApplicationClientUpdate., must be smaller than or equal to 250.');
        }
    ...
    public function setUtmSource($utm_source)
    {
        if (!is_null($utm_source) && (mb_strlen($utm_source) > 250)) {
            throw new \InvalidArgumentException('invalid length for $utm_source when calling PatchedApplicationClientUpdate., must be smaller than or equal to 250.');
        }
    ...
    public function setUtmMedium($utm_medium)
    {
        if (!is_null($utm_medium) && (mb_strlen($utm_medium) > 250)) {
            throw new \InvalidArgumentException('invalid length for $utm_medium when calling PatchedApplicationClientUpdate., must be smaller than or equal to 250.');
        }
    ...
    public function setUtmCampaign($utm_campaign)
    {
        if (!is_null($utm_campaign) && (mb_strlen($utm_campaign) > 250)) {
            throw new \InvalidArgumentException('invalid length for $utm_campaign when calling PatchedApplicationClientUpdate., must be smaller than or equal to 250.');
        }
    ...
    public function setUtmTerm($utm_term)
    {
        if (!is_null($utm_term) && (mb_strlen($utm_term) > 250)) {
            throw new \InvalidArgumentException('invalid length for $utm_term when calling PatchedApplicationClientUpdate., must be smaller than or equal to 250.');
        }
    ...
    public function setUtmContent($utm_content)
    {
        if (!is_null($utm_content) && (mb_strlen($utm_content) > 250)) {
            throw new \InvalidArgumentException('invalid length for $utm_content when calling PatchedApplicationClientUpdate., must be smaller than or equal to 250.');
        }
     ...
     *
     * @param \DateTime|null $marketing_consent_date marketing_consent_date
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $data_consent_date data_consent_date
     *
     * @return self
     */
