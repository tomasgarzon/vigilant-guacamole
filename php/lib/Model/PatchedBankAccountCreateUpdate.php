...
/**
 * PatchedBankAccountCreateUpdate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchedBankAccountCreateUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedBankAccountCreateUpdate';
    ...
    public function setAccountNumber($account_number)
    {
        if (!is_null($account_number) && (mb_strlen($account_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling PatchedBankAccountCreateUpdate., must be smaller than or equal to 30.');
        }
    ...
    public function setAccountSortCode($account_sort_code)
    {
        if (!is_null($account_sort_code) && (mb_strlen($account_sort_code) > 6)) {
            throw new \InvalidArgumentException('invalid length for $account_sort_code when calling PatchedBankAccountCreateUpdate., must be smaller than or equal to 6.');
        }
    ...
    public function setBankName($bank_name)
    {
        if (!is_null($bank_name) && (mb_strlen($bank_name) > 250)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling PatchedBankAccountCreateUpdate., must be smaller than or equal to 250.');
        }
    ...
    public function setIban($iban)
    {
        if (!is_null($iban) && (mb_strlen($iban) > 34)) {
            throw new \InvalidArgumentException('invalid length for $iban when calling PatchedBankAccountCreateUpdate., must be smaller than or equal to 34.');
        }
    ...
    public function setSwiftCode($swift_code)
    {
        if (!is_null($swift_code) && (mb_strlen($swift_code) > 11)) {
            throw new \InvalidArgumentException('invalid length for $swift_code when calling PatchedBankAccountCreateUpdate., must be smaller than or equal to 11.');
        }
