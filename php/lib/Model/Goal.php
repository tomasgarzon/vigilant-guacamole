...
class Goal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['goal_amount'] < 0.1)) {
        ...
        if (($this->container['initial_amount'] < 0.1)) {
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 150)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Goal., must be smaller than or equal to 150.');
        }
     ...
     * Sets goal_amount
     *
     * @param double $goal_amount Desired amount needed to fulfill the goal
     *
     * @return self
     */
    public function setGoalAmount($goal_amount)
    {
        ...
        if (($goal_amount > 1000000000000)) {
            throw new \InvalidArgumentException('invalid value for $goal_amount when calling Goal., must be smaller than or equal to 1000000000000.');
        }
        if (($goal_amount < 0.1)) {
            throw new \InvalidArgumentException('invalid value for $goal_amount when calling Goal., must be bigger than or equal to 0.1.');
        }
     ...
     * Sets deadline
     *
     * @param \DateTime $deadline Due date to reach the goal.
     *
     * @return self
     */
     ...
     * Sets initial_amount
     *
     * @param double $initial_amount Initial deposit amount to start from. No sense to start by 0
     *
     * @return self
     */
    public function setInitialAmount($initial_amount)
    {
        ...
        if (($initial_amount > 1000000000000)) {
            throw new \InvalidArgumentException('invalid value for $initial_amount when calling Goal., must be smaller than or equal to 1000000000000.');
        }
        if (($initial_amount < 0.1)) {
            throw new \InvalidArgumentException('invalid value for $initial_amount when calling Goal., must be bigger than or equal to 0.1.');
        }
    ...
    public function setRecurringAmount($recurring_amount)
    {
        ...
        if (!is_null($recurring_amount) && ($recurring_amount > 1000000000000)) {
            throw new \InvalidArgumentException('invalid value for $recurring_amount when calling Goal., must be smaller than or equal to 1000000000000.');
        }
        if (!is_null($recurring_amount) && ($recurring_amount < -1000000000000)) {
            throw new \InvalidArgumentException('invalid value for $recurring_amount when calling Goal., must be bigger than or equal to -1000000000000.');
        }
    ...
    public function setRiskLevel($risk_level)
    {
        ...
        if (($risk_level > 32767)) {
            throw new \InvalidArgumentException('invalid value for $risk_level when calling Goal., must be smaller than or equal to 32767.');
        }
        if (($risk_level < 0)) {
            throw new \InvalidArgumentException('invalid value for $risk_level when calling Goal., must be bigger than or equal to 0.');
        }
