...
/**
 * AssetModelPortfolio Class Doc Comment
 *
 * @category Class
 ...
 */
class AssetModelPortfolio implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssetModelPortfolio';
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['weight'] > 1)) {
            $invalidProperties[] = "invalid value for 'weight', must be smaller than or equal to 1.";
        }
    ...
    public function setWeight($weight)
    {
        ...
        if (($weight > 1)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling AssetModelPortfolio., must be smaller than or equal to 1.');
        }
        if (($weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling AssetModelPortfolio., must be bigger than or equal to 0.');
        }
