...
/**
 * ApplicationClientUpdate Class Doc Comment
 *
 * @category Class
 ...
 */
class ApplicationClientUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicationClientUpdate';
    ...
    public function setLanguage($language)
    {
        if ((mb_strlen($language) > 5)) {
            throw new \InvalidArgumentException('invalid length for $language when calling ApplicationClientUpdate., must be smaller than or equal to 5.');
        }
    ...
    public function setProfession($profession)
    {
        if (!is_null($profession) && (mb_strlen($profession) > 250)) {
            throw new \InvalidArgumentException('invalid length for $profession when calling ApplicationClientUpdate., must be smaller than or equal to 250.');
        }
    ...
    public function setReferralCode($referral_code)
    {
        if (!is_null($referral_code) && (mb_strlen($referral_code) > 250)) {
            throw new \InvalidArgumentException('invalid length for $referral_code when calling ApplicationClientUpdate., must be smaller than or equal to 250.');
        }
    ...
    public function setUtmSource($utm_source)
    {
        if (!is_null($utm_source) && (mb_strlen($utm_source) > 250)) {
            throw new \InvalidArgumentException('invalid length for $utm_source when calling ApplicationClientUpdate., must be smaller than or equal to 250.');
        }
    ...
    public function setUtmMedium($utm_medium)
    {
        if (!is_null($utm_medium) && (mb_strlen($utm_medium) > 250)) {
            throw new \InvalidArgumentException('invalid length for $utm_medium when calling ApplicationClientUpdate., must be smaller than or equal to 250.');
        }
    ...
    public function setUtmCampaign($utm_campaign)
    {
        if (!is_null($utm_campaign) && (mb_strlen($utm_campaign) > 250)) {
            throw new \InvalidArgumentException('invalid length for $utm_campaign when calling ApplicationClientUpdate., must be smaller than or equal to 250.');
        }
    ...
    public function setUtmTerm($utm_term)
    {
        if (!is_null($utm_term) && (mb_strlen($utm_term) > 250)) {
            throw new \InvalidArgumentException('invalid length for $utm_term when calling ApplicationClientUpdate., must be smaller than or equal to 250.');
        }
    ...
    public function setUtmContent($utm_content)
    {
        if (!is_null($utm_content) && (mb_strlen($utm_content) > 250)) {
            throw new \InvalidArgumentException('invalid length for $utm_content when calling ApplicationClientUpdate., must be smaller than or equal to 250.');
        }
