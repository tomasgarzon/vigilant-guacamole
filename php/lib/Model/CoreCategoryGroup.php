...
/**
 * CoreCategoryGroup Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreCategoryGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CoreCategoryGroup';
    ...
    public function setRiskLevel($risk_level)
    {
        ...
        if (($risk_level > 32767)) {
            throw new \InvalidArgumentException('invalid value for $risk_level when calling CoreCategoryGroup., must be smaller than or equal to 32767.');
        }
        if (($risk_level < 0)) {
            throw new \InvalidArgumentException('invalid value for $risk_level when calling CoreCategoryGroup., must be bigger than or equal to 0.');
        }
     ...
     * Sets categories
     *
     * @param \OpenAPI\Client\Model\Category[] $categories categories
     *
     * @return self
     */
