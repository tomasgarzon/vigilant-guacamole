...
/**
 * PortfolioDetail Class Doc Comment
 *
 * @category Class
 ...
 */
class PortfolioDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PortfolioDetail';
    ...
    protected static $openAPITypes = [
        ...
        'risk_level' => 'int',
        'time_horizon' => 'int',
        'status' => '\OpenAPI\Client\Model\Status2efEnum',
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['performance'] < 0)) {
            $invalidProperties[] = "invalid value for 'performance', must be bigger than or equal to 0.";
        }

        if ($this->container['deposit_reference'] === null) {
            $invalidProperties[] = "'deposit_reference' can't be null";
        }
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 150)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PortfolioDetail., must be smaller than or equal to 150.');
        }
    ...
    public function setRiskLevel($risk_level)
    {
        ...
        if (!is_null($risk_level) && ($risk_level > 32767)) {
            throw new \InvalidArgumentException('invalid value for $risk_level when calling PortfolioDetail., must be smaller than or equal to 32767.');
        }
        if (!is_null($risk_level) && ($risk_level < 0)) {
            throw new \InvalidArgumentException('invalid value for $risk_level when calling PortfolioDetail., must be bigger than or equal to 0.');
        }
    ...
    public function setTimeHorizon($time_horizon)
    {
        ...
        if (!is_null($time_horizon) && ($time_horizon > 32767)) {
            throw new \InvalidArgumentException('invalid value for $time_horizon when calling PortfolioDetail., must be smaller than or equal to 32767.');
        }
        if (!is_null($time_horizon) && ($time_horizon < 0)) {
            throw new \InvalidArgumentException('invalid value for $time_horizon when calling PortfolioDetail., must be bigger than or equal to 0.');
        }
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\Status2efEnum|null
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\Status2efEnum|null $status status
     *
     * @return self
     */
     ...
     * Sets extra_data
     *
     * @param array<string,mixed>|null $extra_data Additional Portfolio attributes
     *
     * @return self
     */
    ...
    public function setBalance($balance)
    {
        ...
        if (($balance > 1000000000000)) {
            throw new \InvalidArgumentException('invalid value for $balance when calling PortfolioDetail., must be smaller than or equal to 1000000000000.');
        }
        if (($balance < 0)) {
            throw new \InvalidArgumentException('invalid value for $balance when calling PortfolioDetail., must be bigger than or equal to 0.');
        }
    ...
    public function setPerformance($performance)
    {
        ...
        if (($performance > 1000000000000)) {
            throw new \InvalidArgumentException('invalid value for $performance when calling PortfolioDetail., must be smaller than or equal to 1000000000000.');
        }
        if (($performance < 0)) {
            throw new \InvalidArgumentException('invalid value for $performance when calling PortfolioDetail., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string $deposit_reference deposit_reference
     *
     * @return self
     */
