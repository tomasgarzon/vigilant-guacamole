...
class Watchlist implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'uuid' => 'string',
        'name' => 'string',
        'assets' => '\OpenAPI\Client\Model\RelatedAssetSerializerWithPermission[]'
    ];
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 250)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Watchlist., must be smaller than or equal to 250.');
        }
     ...
     * Gets assets
     *
     * @return \OpenAPI\Client\Model\RelatedAssetSerializerWithPermission[]
     */
     ...
     * Sets assets
     *
     * @param \OpenAPI\Client\Model\RelatedAssetSerializerWithPermission[] $assets assets
     *
     * @return self
     */
