...
/**
 * AUMEvoluation Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AUMEvoluation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AUMEvoluation';
    ...
    public function setBalance($balance)
    {
        ...
        if (($balance > 1000000000000)) {
            throw new \InvalidArgumentException('invalid value for $balance when calling AUMEvoluation., must be smaller than or equal to 1000000000000.');
        }
        if (($balance < 0)) {
            throw new \InvalidArgumentException('invalid value for $balance when calling AUMEvoluation., must be bigger than or equal to 0.');
        }
