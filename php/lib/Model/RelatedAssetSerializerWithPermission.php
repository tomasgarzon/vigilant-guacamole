...
/**
 * RelatedAssetSerializerWithPermission Class Doc Comment
 *
 * @category Class
 ...
 */
class RelatedAssetSerializerWithPermission implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RelatedAssetSerializerWithPermission';
    ...
    public function setIsin($isin)
    {
        if ((mb_strlen($isin) > 120)) {
            throw new \InvalidArgumentException('invalid length for $isin when calling RelatedAssetSerializerWithPermission., must be smaller than or equal to 120.');
        }
    ...
    public function setTicker($ticker)
    {
        if ((mb_strlen($ticker) > 120)) {
            throw new \InvalidArgumentException('invalid length for $ticker when calling RelatedAssetSerializerWithPermission., must be smaller than or equal to 120.');
        }
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 250)) {
            throw new \InvalidArgumentException('invalid length for $name when calling RelatedAssetSerializerWithPermission., must be smaller than or equal to 250.');
        }
