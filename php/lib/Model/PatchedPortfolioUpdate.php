...
/**
 * PatchedPortfolioUpdate Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedPortfolioUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedPortfolioUpdate';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 150)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedPortfolioUpdate., must be smaller than or equal to 150.');
        }
     ...
     * Sets portfolio_type
     *
     * @param string|null $portfolio_type portfolio_type
     *
     * @return self
     */
    ...
    public function setRiskLevel($risk_level)
    {
        ...
        if (!is_null($risk_level) && ($risk_level > 32767)) {
            throw new \InvalidArgumentException('invalid value for $risk_level when calling PatchedPortfolioUpdate., must be smaller than or equal to 32767.');
        }
        if (!is_null($risk_level) && ($risk_level < 0)) {
            throw new \InvalidArgumentException('invalid value for $risk_level when calling PatchedPortfolioUpdate., must be bigger than or equal to 0.');
        }
    ...
    public function setTimeHorizon($time_horizon)
    {
        ...
        if (!is_null($time_horizon) && ($time_horizon > 32767)) {
            throw new \InvalidArgumentException('invalid value for $time_horizon when calling PatchedPortfolioUpdate., must be smaller than or equal to 32767.');
        }
        if (!is_null($time_horizon) && ($time_horizon < 0)) {
            throw new \InvalidArgumentException('invalid value for $time_horizon when calling PatchedPortfolioUpdate., must be bigger than or equal to 0.');
        }
     ...
     * Sets status
     *
     * @param Status2efEnum|null $status status
     *
     * @return self
     */
