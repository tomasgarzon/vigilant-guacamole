...
/**
 * PortfolioCreate Class Doc Comment
 *
 * @category Class
 ...
 */
class PortfolioCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PortfolioCreate';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 150)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PortfolioCreate., must be smaller than or equal to 150.');
        }
