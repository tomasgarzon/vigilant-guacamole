...
// PaginatedAllocationListList struct for PaginatedAllocationListList
type PaginatedAllocationListList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results *[]AllocationList `json:"results,omitempty"`
}
...
func NewPaginatedAllocationListList() *PaginatedAllocationListList {
	this := PaginatedAllocationListList{}
	return &this
}
...
func (o *PaginatedAllocationListList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedAllocationListList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []AllocationList and assigns it to the Results field.
func (o *PaginatedAllocationListList) SetResults(v []AllocationList) {
	o.Results = &v
}

func (o PaginatedAllocationListList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedAllocationListList struct {
	value *PaginatedAllocationListList
	isSet bool
}

func (v NullablePaginatedAllocationListList) Get() *PaginatedAllocationListList {
	return v.value
}

func (v *NullablePaginatedAllocationListList) Set(val *PaginatedAllocationListList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedAllocationListList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedAllocationListList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedAllocationListList(val *PaginatedAllocationListList) *NullablePaginatedAllocationListList {
	return &NullablePaginatedAllocationListList{value: val, isSet: true}
}

func (v NullablePaginatedAllocationListList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedAllocationListList) UnmarshalJSON(src []byte) error {
	v.isSet = true
