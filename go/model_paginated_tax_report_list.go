...
// PaginatedTaxReportList struct for PaginatedTaxReportList
type PaginatedTaxReportList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results *[]TaxReport `json:"results,omitempty"`
}
...
func (o *PaginatedTaxReportList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedTaxReportList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []TaxReport and assigns it to the Results field.
func (o *PaginatedTaxReportList) SetResults(v []TaxReport) {
	o.Results = &v
}

func (o PaginatedTaxReportList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedTaxReportList struct {
	value *PaginatedTaxReportList
	isSet bool
}

func (v NullablePaginatedTaxReportList) Get() *PaginatedTaxReportList {
	return v.value
}

func (v *NullablePaginatedTaxReportList) Set(val *PaginatedTaxReportList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedTaxReportList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedTaxReportList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedTaxReportList(val *PaginatedTaxReportList) *NullablePaginatedTaxReportList {
	return &NullablePaginatedTaxReportList{value: val, isSet: true}
}

func (v NullablePaginatedTaxReportList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedTaxReportList) UnmarshalJSON(src []byte) error {
	v.isSet = true
