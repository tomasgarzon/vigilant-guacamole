...
// PaginatedClientDetailList struct for PaginatedClientDetailList
type PaginatedClientDetailList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results *[]ClientDetail `json:"results,omitempty"`
}
...
func NewPaginatedClientDetailList() *PaginatedClientDetailList {
	this := PaginatedClientDetailList{}
	return &this
}
...
func (o *PaginatedClientDetailList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedClientDetailList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []ClientDetail and assigns it to the Results field.
func (o *PaginatedClientDetailList) SetResults(v []ClientDetail) {
	o.Results = &v
}

func (o PaginatedClientDetailList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedClientDetailList struct {
	value *PaginatedClientDetailList
	isSet bool
}

func (v NullablePaginatedClientDetailList) Get() *PaginatedClientDetailList {
	return v.value
}

func (v *NullablePaginatedClientDetailList) Set(val *PaginatedClientDetailList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedClientDetailList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedClientDetailList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedClientDetailList(val *PaginatedClientDetailList) *NullablePaginatedClientDetailList {
	return &NullablePaginatedClientDetailList{value: val, isSet: true}
}

func (v NullablePaginatedClientDetailList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedClientDetailList) UnmarshalJSON(src []byte) error {
	v.isSet = true
