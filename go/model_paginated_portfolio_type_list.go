...
// PaginatedPortfolioTypeList struct for PaginatedPortfolioTypeList
type PaginatedPortfolioTypeList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results *[]PortfolioType `json:"results,omitempty"`
}
...
func NewPaginatedPortfolioTypeList() *PaginatedPortfolioTypeList {
	this := PaginatedPortfolioTypeList{}
	return &this
}
...
func (o *PaginatedPortfolioTypeList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedPortfolioTypeList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []PortfolioType and assigns it to the Results field.
func (o *PaginatedPortfolioTypeList) SetResults(v []PortfolioType) {
	o.Results = &v
}

func (o PaginatedPortfolioTypeList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedPortfolioTypeList struct {
	value *PaginatedPortfolioTypeList
	isSet bool
}

func (v NullablePaginatedPortfolioTypeList) Get() *PaginatedPortfolioTypeList {
	return v.value
}

func (v *NullablePaginatedPortfolioTypeList) Set(val *PaginatedPortfolioTypeList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedPortfolioTypeList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedPortfolioTypeList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedPortfolioTypeList(val *PaginatedPortfolioTypeList) *NullablePaginatedPortfolioTypeList {
	return &NullablePaginatedPortfolioTypeList{value: val, isSet: true}
}

func (v NullablePaginatedPortfolioTypeList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedPortfolioTypeList) UnmarshalJSON(src []byte) error {
	v.isSet = true
