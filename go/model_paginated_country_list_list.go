...
// PaginatedCountryListList struct for PaginatedCountryListList
type PaginatedCountryListList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results *[]CountryList `json:"results,omitempty"`
}
...
func (o *PaginatedCountryListList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedCountryListList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []CountryList and assigns it to the Results field.
func (o *PaginatedCountryListList) SetResults(v []CountryList) {
	o.Results = &v
}

func (o PaginatedCountryListList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedCountryListList struct {
	value *PaginatedCountryListList
	isSet bool
}

func (v NullablePaginatedCountryListList) Get() *PaginatedCountryListList {
	return v.value
}

func (v *NullablePaginatedCountryListList) Set(val *PaginatedCountryListList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedCountryListList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedCountryListList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedCountryListList(val *PaginatedCountryListList) *NullablePaginatedCountryListList {
	return &NullablePaginatedCountryListList{value: val, isSet: true}
}

func (v NullablePaginatedCountryListList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedCountryListList) UnmarshalJSON(src []byte) error {
	v.isSet = true
