...
// PaginatedCoreCategoryGroupList struct for PaginatedCoreCategoryGroupList
type PaginatedCoreCategoryGroupList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results *[]CoreCategoryGroup `json:"results,omitempty"`
}
...
func NewPaginatedCoreCategoryGroupList() *PaginatedCoreCategoryGroupList {
	this := PaginatedCoreCategoryGroupList{}
	return &this
}
...
func (o *PaginatedCoreCategoryGroupList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedCoreCategoryGroupList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []CoreCategoryGroup and assigns it to the Results field.
func (o *PaginatedCoreCategoryGroupList) SetResults(v []CoreCategoryGroup) {
	o.Results = &v
}

func (o PaginatedCoreCategoryGroupList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedCoreCategoryGroupList struct {
	value *PaginatedCoreCategoryGroupList
	isSet bool
}

func (v NullablePaginatedCoreCategoryGroupList) Get() *PaginatedCoreCategoryGroupList {
	return v.value
}

func (v *NullablePaginatedCoreCategoryGroupList) Set(val *PaginatedCoreCategoryGroupList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedCoreCategoryGroupList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedCoreCategoryGroupList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedCoreCategoryGroupList(val *PaginatedCoreCategoryGroupList) *NullablePaginatedCoreCategoryGroupList {
	return &NullablePaginatedCoreCategoryGroupList{value: val, isSet: true}
}

func (v NullablePaginatedCoreCategoryGroupList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedCoreCategoryGroupList) UnmarshalJSON(src []byte) error {
	v.isSet = true
