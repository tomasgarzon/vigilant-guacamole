...
// PaginatedNationalDocumentList struct for PaginatedNationalDocumentList
type PaginatedNationalDocumentList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results *[]NationalDocument `json:"results,omitempty"`
}
...
func NewPaginatedNationalDocumentList() *PaginatedNationalDocumentList {
	this := PaginatedNationalDocumentList{}
	return &this
}
...
func (o *PaginatedNationalDocumentList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedNationalDocumentList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []NationalDocument and assigns it to the Results field.
func (o *PaginatedNationalDocumentList) SetResults(v []NationalDocument) {
	o.Results = &v
}

func (o PaginatedNationalDocumentList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedNationalDocumentList struct {
	value *PaginatedNationalDocumentList
	isSet bool
}

func (v NullablePaginatedNationalDocumentList) Get() *PaginatedNationalDocumentList {
	return v.value
}

func (v *NullablePaginatedNationalDocumentList) Set(val *PaginatedNationalDocumentList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedNationalDocumentList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedNationalDocumentList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedNationalDocumentList(val *PaginatedNationalDocumentList) *NullablePaginatedNationalDocumentList {
	return &NullablePaginatedNationalDocumentList{value: val, isSet: true}
}

func (v NullablePaginatedNationalDocumentList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedNationalDocumentList) UnmarshalJSON(src []byte) error {
	v.isSet = true
