...
// PaginatedOrderListList struct for PaginatedOrderListList
type PaginatedOrderListList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results *[]OrderList `json:"results,omitempty"`
}
...
func (o *PaginatedOrderListList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedOrderListList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []OrderList and assigns it to the Results field.
func (o *PaginatedOrderListList) SetResults(v []OrderList) {
	o.Results = &v
}

func (o PaginatedOrderListList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedOrderListList struct {
	value *PaginatedOrderListList
	isSet bool
}

func (v NullablePaginatedOrderListList) Get() *PaginatedOrderListList {
	return v.value
}

func (v *NullablePaginatedOrderListList) Set(val *PaginatedOrderListList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedOrderListList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedOrderListList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedOrderListList(val *PaginatedOrderListList) *NullablePaginatedOrderListList {
	return &NullablePaginatedOrderListList{value: val, isSet: true}
}

func (v NullablePaginatedOrderListList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedOrderListList) UnmarshalJSON(src []byte) error {
	v.isSet = true
