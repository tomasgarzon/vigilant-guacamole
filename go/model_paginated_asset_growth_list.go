...
// PaginatedAssetGrowthList struct for PaginatedAssetGrowthList
type PaginatedAssetGrowthList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results *[]AssetGrowth `json:"results,omitempty"`
}
...
func (o *PaginatedAssetGrowthList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedAssetGrowthList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []AssetGrowth and assigns it to the Results field.
func (o *PaginatedAssetGrowthList) SetResults(v []AssetGrowth) {
	o.Results = &v
}

func (o PaginatedAssetGrowthList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedAssetGrowthList struct {
	value *PaginatedAssetGrowthList
	isSet bool
}

func (v NullablePaginatedAssetGrowthList) Get() *PaginatedAssetGrowthList {
	return v.value
}

func (v *NullablePaginatedAssetGrowthList) Set(val *PaginatedAssetGrowthList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedAssetGrowthList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedAssetGrowthList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedAssetGrowthList(val *PaginatedAssetGrowthList) *NullablePaginatedAssetGrowthList {
	return &NullablePaginatedAssetGrowthList{value: val, isSet: true}
}

func (v NullablePaginatedAssetGrowthList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedAssetGrowthList) UnmarshalJSON(src []byte) error {
	v.isSet = true
