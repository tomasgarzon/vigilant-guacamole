...
// PaginatedAssetCategoryList struct for PaginatedAssetCategoryList
type PaginatedAssetCategoryList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results *[]AssetCategory `json:"results,omitempty"`
}
...
func NewPaginatedAssetCategoryList() *PaginatedAssetCategoryList {
	this := PaginatedAssetCategoryList{}
	return &this
}
...
func (o *PaginatedAssetCategoryList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedAssetCategoryList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []AssetCategory and assigns it to the Results field.
func (o *PaginatedAssetCategoryList) SetResults(v []AssetCategory) {
	o.Results = &v
}

func (o PaginatedAssetCategoryList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedAssetCategoryList struct {
	value *PaginatedAssetCategoryList
	isSet bool
}

func (v NullablePaginatedAssetCategoryList) Get() *PaginatedAssetCategoryList {
	return v.value
}

func (v *NullablePaginatedAssetCategoryList) Set(val *PaginatedAssetCategoryList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedAssetCategoryList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedAssetCategoryList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedAssetCategoryList(val *PaginatedAssetCategoryList) *NullablePaginatedAssetCategoryList {
	return &NullablePaginatedAssetCategoryList{value: val, isSet: true}
}

func (v NullablePaginatedAssetCategoryList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedAssetCategoryList) UnmarshalJSON(src []byte) error {
	v.isSet = true
