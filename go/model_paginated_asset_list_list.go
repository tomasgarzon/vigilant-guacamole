...
// PaginatedAssetListList struct for PaginatedAssetListList
type PaginatedAssetListList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results *[]AssetList `json:"results,omitempty"`
}
...
func (o *PaginatedAssetListList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedAssetListList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []AssetList and assigns it to the Results field.
func (o *PaginatedAssetListList) SetResults(v []AssetList) {
	o.Results = &v
}

func (o PaginatedAssetListList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedAssetListList struct {
	value *PaginatedAssetListList
	isSet bool
}

func (v NullablePaginatedAssetListList) Get() *PaginatedAssetListList {
	return v.value
}

func (v *NullablePaginatedAssetListList) Set(val *PaginatedAssetListList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedAssetListList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedAssetListList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedAssetListList(val *PaginatedAssetListList) *NullablePaginatedAssetListList {
	return &NullablePaginatedAssetListList{value: val, isSet: true}
}

func (v NullablePaginatedAssetListList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedAssetListList) UnmarshalJSON(src []byte) error {
	v.isSet = true
