...
// PaginatedFeedActivityListList struct for PaginatedFeedActivityListList
type PaginatedFeedActivityListList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results *[]FeedActivityList `json:"results,omitempty"`
}
...
func NewPaginatedFeedActivityListList() *PaginatedFeedActivityListList {
	this := PaginatedFeedActivityListList{}
	return &this
}
...
func (o *PaginatedFeedActivityListList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedFeedActivityListList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []FeedActivityList and assigns it to the Results field.
func (o *PaginatedFeedActivityListList) SetResults(v []FeedActivityList) {
	o.Results = &v
}

func (o PaginatedFeedActivityListList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedFeedActivityListList struct {
	value *PaginatedFeedActivityListList
	isSet bool
}

func (v NullablePaginatedFeedActivityListList) Get() *PaginatedFeedActivityListList {
	return v.value
}

func (v *NullablePaginatedFeedActivityListList) Set(val *PaginatedFeedActivityListList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedFeedActivityListList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedFeedActivityListList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedFeedActivityListList(val *PaginatedFeedActivityListList) *NullablePaginatedFeedActivityListList {
	return &NullablePaginatedFeedActivityListList{value: val, isSet: true}
}

func (v NullablePaginatedFeedActivityListList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedFeedActivityListList) UnmarshalJSON(src []byte) error {
	v.isSet = true
