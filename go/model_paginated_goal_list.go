...
// PaginatedGoalList struct for PaginatedGoalList
type PaginatedGoalList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results *[]Goal `json:"results,omitempty"`
}
...
func (o *PaginatedGoalList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedGoalList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []Goal and assigns it to the Results field.
func (o *PaginatedGoalList) SetResults(v []Goal) {
	o.Results = &v
}

func (o PaginatedGoalList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedGoalList struct {
	value *PaginatedGoalList
	isSet bool
}

func (v NullablePaginatedGoalList) Get() *PaginatedGoalList {
	return v.value
}

func (v *NullablePaginatedGoalList) Set(val *PaginatedGoalList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedGoalList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedGoalList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedGoalList(val *PaginatedGoalList) *NullablePaginatedGoalList {
	return &NullablePaginatedGoalList{value: val, isSet: true}
}

func (v NullablePaginatedGoalList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedGoalList) UnmarshalJSON(src []byte) error {
	v.isSet = true
