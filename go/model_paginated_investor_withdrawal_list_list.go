...
// PaginatedInvestorWithdrawalListList struct for PaginatedInvestorWithdrawalListList
type PaginatedInvestorWithdrawalListList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results *[]InvestorWithdrawalList `json:"results,omitempty"`
}
...
func NewPaginatedInvestorWithdrawalListList() *PaginatedInvestorWithdrawalListList {
	this := PaginatedInvestorWithdrawalListList{}
	return &this
}
...
func (o *PaginatedInvestorWithdrawalListList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedInvestorWithdrawalListList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o *PaginatedInvestorWithdrawalListList) GetResults() []InvestorWithdrawalList {
	if o == nil || o.Results == nil {
		var ret []InvestorWithdrawalList
		return ret
	}
	return *o.Results
}
...
// SetResults gets a reference to the given []InvestorWithdrawalList and assigns it to the Results field.
func (o *PaginatedInvestorWithdrawalListList) SetResults(v []InvestorWithdrawalList) {
	o.Results = &v
}

func (o PaginatedInvestorWithdrawalListList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedInvestorWithdrawalListList struct {
	value *PaginatedInvestorWithdrawalListList
	isSet bool
}

func (v NullablePaginatedInvestorWithdrawalListList) Get() *PaginatedInvestorWithdrawalListList {
	return v.value
}

func (v *NullablePaginatedInvestorWithdrawalListList) Set(val *PaginatedInvestorWithdrawalListList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedInvestorWithdrawalListList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedInvestorWithdrawalListList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedInvestorWithdrawalListList(val *PaginatedInvestorWithdrawalListList) *NullablePaginatedInvestorWithdrawalListList {
	return &NullablePaginatedInvestorWithdrawalListList{value: val, isSet: true}
}

func (v NullablePaginatedInvestorWithdrawalListList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedInvestorWithdrawalListList) UnmarshalJSON(src []byte) error {
	v.isSet = true
