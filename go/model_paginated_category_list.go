...
// PaginatedCategoryList struct for PaginatedCategoryList
...
func (o *PaginatedCategoryList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedCategoryList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o PaginatedCategoryList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedCategoryList struct {
	value *PaginatedCategoryList
	isSet bool
}

func (v NullablePaginatedCategoryList) Get() *PaginatedCategoryList {
	return v.value
}

func (v *NullablePaginatedCategoryList) Set(val *PaginatedCategoryList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedCategoryList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedCategoryList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedCategoryList(val *PaginatedCategoryList) *NullablePaginatedCategoryList {
	return &NullablePaginatedCategoryList{value: val, isSet: true}
}

func (v NullablePaginatedCategoryList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedCategoryList) UnmarshalJSON(src []byte) error {
	v.isSet = true
