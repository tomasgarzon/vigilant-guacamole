...
// PaginatedVerificationListList struct for PaginatedVerificationListList
type PaginatedVerificationListList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results *[]VerificationList `json:"results,omitempty"`
}
...
func NewPaginatedVerificationListList() *PaginatedVerificationListList {
	this := PaginatedVerificationListList{}
	return &this
}
...
func (o *PaginatedVerificationListList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedVerificationListList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []VerificationList and assigns it to the Results field.
func (o *PaginatedVerificationListList) SetResults(v []VerificationList) {
	o.Results = &v
}

func (o PaginatedVerificationListList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedVerificationListList struct {
	value *PaginatedVerificationListList
	isSet bool
}

func (v NullablePaginatedVerificationListList) Get() *PaginatedVerificationListList {
	return v.value
}

func (v *NullablePaginatedVerificationListList) Set(val *PaginatedVerificationListList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedVerificationListList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedVerificationListList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedVerificationListList(val *PaginatedVerificationListList) *NullablePaginatedVerificationListList {
	return &NullablePaginatedVerificationListList{value: val, isSet: true}
}

func (v NullablePaginatedVerificationListList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedVerificationListList) UnmarshalJSON(src []byte) error {
	v.isSet = true
