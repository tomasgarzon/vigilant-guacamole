...
// PaginatedStatementList struct for PaginatedStatementList
type PaginatedStatementList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results *[]Statement `json:"results,omitempty"`
}
...
func (o *PaginatedStatementList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedStatementList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []Statement and assigns it to the Results field.
func (o *PaginatedStatementList) SetResults(v []Statement) {
	o.Results = &v
}

func (o PaginatedStatementList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedStatementList struct {
	value *PaginatedStatementList
	isSet bool
}

func (v NullablePaginatedStatementList) Get() *PaginatedStatementList {
	return v.value
}

func (v *NullablePaginatedStatementList) Set(val *PaginatedStatementList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedStatementList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedStatementList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedStatementList(val *PaginatedStatementList) *NullablePaginatedStatementList {
	return &NullablePaginatedStatementList{value: val, isSet: true}
}

func (v NullablePaginatedStatementList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedStatementList) UnmarshalJSON(src []byte) error {
	v.isSet = true
