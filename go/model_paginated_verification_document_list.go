...
// PaginatedVerificationDocumentList struct for PaginatedVerificationDocumentList
type PaginatedVerificationDocumentList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results *[]VerificationDocument `json:"results,omitempty"`
}
...
func NewPaginatedVerificationDocumentList() *PaginatedVerificationDocumentList {
	this := PaginatedVerificationDocumentList{}
	return &this
}
...
func (o *PaginatedVerificationDocumentList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedVerificationDocumentList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []VerificationDocument and assigns it to the Results field.
func (o *PaginatedVerificationDocumentList) SetResults(v []VerificationDocument) {
	o.Results = &v
}

func (o PaginatedVerificationDocumentList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedVerificationDocumentList struct {
	value *PaginatedVerificationDocumentList
	isSet bool
}

func (v NullablePaginatedVerificationDocumentList) Get() *PaginatedVerificationDocumentList {
	return v.value
}

func (v *NullablePaginatedVerificationDocumentList) Set(val *PaginatedVerificationDocumentList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedVerificationDocumentList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedVerificationDocumentList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedVerificationDocumentList(val *PaginatedVerificationDocumentList) *NullablePaginatedVerificationDocumentList {
	return &NullablePaginatedVerificationDocumentList{value: val, isSet: true}
}

func (v NullablePaginatedVerificationDocumentList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedVerificationDocumentList) UnmarshalJSON(src []byte) error {
	v.isSet = true
