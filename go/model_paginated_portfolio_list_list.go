...
// PaginatedPortfolioListList struct for PaginatedPortfolioListList
type PaginatedPortfolioListList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results *[]PortfolioList `json:"results,omitempty"`
}
...
func NewPaginatedPortfolioListList() *PaginatedPortfolioListList {
	this := PaginatedPortfolioListList{}
	return &this
}
...
func (o *PaginatedPortfolioListList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedPortfolioListList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []PortfolioList and assigns it to the Results field.
func (o *PaginatedPortfolioListList) SetResults(v []PortfolioList) {
	o.Results = &v
}

func (o PaginatedPortfolioListList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedPortfolioListList struct {
	value *PaginatedPortfolioListList
	isSet bool
}

func (v NullablePaginatedPortfolioListList) Get() *PaginatedPortfolioListList {
	return v.value
}

func (v *NullablePaginatedPortfolioListList) Set(val *PaginatedPortfolioListList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedPortfolioListList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedPortfolioListList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedPortfolioListList(val *PaginatedPortfolioListList) *NullablePaginatedPortfolioListList {
	return &NullablePaginatedPortfolioListList{value: val, isSet: true}
}

func (v NullablePaginatedPortfolioListList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedPortfolioListList) UnmarshalJSON(src []byte) error {
	v.isSet = true
