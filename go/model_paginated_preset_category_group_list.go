...
// PaginatedPresetCategoryGroupList struct for PaginatedPresetCategoryGroupList
type PaginatedPresetCategoryGroupList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results *[]PresetCategoryGroup `json:"results,omitempty"`
}
...
func NewPaginatedPresetCategoryGroupList() *PaginatedPresetCategoryGroupList {
	this := PaginatedPresetCategoryGroupList{}
	return &this
}
...
func (o *PaginatedPresetCategoryGroupList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedPresetCategoryGroupList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []PresetCategoryGroup and assigns it to the Results field.
func (o *PaginatedPresetCategoryGroupList) SetResults(v []PresetCategoryGroup) {
	o.Results = &v
}

func (o PaginatedPresetCategoryGroupList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedPresetCategoryGroupList struct {
	value *PaginatedPresetCategoryGroupList
	isSet bool
}

func (v NullablePaginatedPresetCategoryGroupList) Get() *PaginatedPresetCategoryGroupList {
	return v.value
}

func (v *NullablePaginatedPresetCategoryGroupList) Set(val *PaginatedPresetCategoryGroupList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedPresetCategoryGroupList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedPresetCategoryGroupList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedPresetCategoryGroupList(val *PaginatedPresetCategoryGroupList) *NullablePaginatedPresetCategoryGroupList {
	return &NullablePaginatedPresetCategoryGroupList{value: val, isSet: true}
}

func (v NullablePaginatedPresetCategoryGroupList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedPresetCategoryGroupList) UnmarshalJSON(src []byte) error {
	v.isSet = true
