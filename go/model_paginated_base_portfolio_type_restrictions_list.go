...
// PaginatedBasePortfolioTypeRestrictionsList struct for PaginatedBasePortfolioTypeRestrictionsList
type PaginatedBasePortfolioTypeRestrictionsList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results *[]BasePortfolioTypeRestrictions `json:"results,omitempty"`
}
...
func NewPaginatedBasePortfolioTypeRestrictionsList() *PaginatedBasePortfolioTypeRestrictionsList {
	this := PaginatedBasePortfolioTypeRestrictionsList{}
	return &this
}
...
func (o *PaginatedBasePortfolioTypeRestrictionsList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedBasePortfolioTypeRestrictionsList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o *PaginatedBasePortfolioTypeRestrictionsList) GetResults() []BasePortfolioTypeRestrictions {
	if o == nil || o.Results == nil {
		var ret []BasePortfolioTypeRestrictions
		return ret
	}
	return *o.Results
}
...
// SetResults gets a reference to the given []BasePortfolioTypeRestrictions and assigns it to the Results field.
func (o *PaginatedBasePortfolioTypeRestrictionsList) SetResults(v []BasePortfolioTypeRestrictions) {
	o.Results = &v
}

func (o PaginatedBasePortfolioTypeRestrictionsList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedBasePortfolioTypeRestrictionsList struct {
	value *PaginatedBasePortfolioTypeRestrictionsList
	isSet bool
}

func (v NullablePaginatedBasePortfolioTypeRestrictionsList) Get() *PaginatedBasePortfolioTypeRestrictionsList {
	return v.value
}

func (v *NullablePaginatedBasePortfolioTypeRestrictionsList) Set(val *PaginatedBasePortfolioTypeRestrictionsList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedBasePortfolioTypeRestrictionsList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedBasePortfolioTypeRestrictionsList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedBasePortfolioTypeRestrictionsList(val *PaginatedBasePortfolioTypeRestrictionsList) *NullablePaginatedBasePortfolioTypeRestrictionsList {
	return &NullablePaginatedBasePortfolioTypeRestrictionsList{value: val, isSet: true}
}

func (v NullablePaginatedBasePortfolioTypeRestrictionsList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedBasePortfolioTypeRestrictionsList) UnmarshalJSON(src []byte) error {
	v.isSet = true
