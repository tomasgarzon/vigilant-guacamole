...
class Position(ModelNormal):
    ...
    read_only_vars = {
        'asset',  # noqa: E501
        'weight',  # noqa: E501
        'fx_rate_account',  # noqa: E501
        'asset_currency_value',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, asset, shares, price, value, weight, fx_rate_account, asset_currency_value, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            value (float):
            weight (float):
            fx_rate_account (float):
            asset_currency_value (float):
    ...
    @convert_js_args_to_python_args
    def __init__(self, shares, price, value, *args, **kwargs):  # noqa: E501
        """Position - a model defined in OpenAPI
