...
class AUMPortfolioRisk(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, risk_level, balance, *args, **kwargs):  # noqa: E501
        """AUMPortfolioRisk - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, risk_level, balance, *args, **kwargs):  # noqa: E501
        """AUMPortfolioRisk - a model defined in OpenAPI
