...
class AssetList(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, uuid, name, isin, ticker, status, market, currency, extra_data, categories, asset_type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, currency, categories, *args, **kwargs):  # noqa: E501
        """AssetList - a model defined in OpenAPI
