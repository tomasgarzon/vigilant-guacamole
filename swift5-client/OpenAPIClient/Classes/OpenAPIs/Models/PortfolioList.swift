...
public struct PortfolioList: Codable, Hashable {
    ...
    public init(uuid: UUID, name: String, portfolioType: String, riskLevel: Int, timeHorizon: Int, status: Status2efEnum, balance: Double, invested: Double, currency: String? = nil, created: Date, advisor: String? = nil, adviceEngine: String? = nil) {
        self.uuid = uuid
        self.name = name
