...
public struct PortfolioCreate: Codable, Hashable {
    ...
    public init(uuid: UUID, name: String, portfolioType: String, riskLevel: Int, timeHorizon: Int, status: Status2efEnum, currency: String? = nil, created: Date, activated: Date, advisor: String, adviceEngine: String, extraData: [String: AnyCodable]? = nil, client: String? = nil) {
        self.uuid = uuid
        self.name = name
