...
TaxInformationAPI.clientTaxInformationDelete(clientUuid: clientUuid, uuid: uuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
TaxInformationAPI.clientTaxInformationPartialUpdate(clientUuid: clientUuid, uuid: uuid, patchedTaxInformationCreateUpdate: patchedTaxInformationCreateUpdate) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
TaxInformationAPI.clientTaxInformationRetrieve(clientUuid: clientUuid, uuid: uuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
TaxInformationAPI.clientTaxInformationUpdate(clientUuid: clientUuid, uuid: uuid, taxInformationCreateUpdate: taxInformationCreateUpdate) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
