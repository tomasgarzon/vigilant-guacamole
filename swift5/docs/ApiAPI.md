...
```swift
    open class func apiV2PortfoliosDestroy(portfolioUuid: UUID, uuid: UUID, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
ApiAPI.apiV2PortfoliosDestroy(portfolioUuid: portfolioUuid, uuid: uuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
let portfolioType = 987 // Int |  (optional)
let status = ["status_example"] // [String] |  (optional)
let valuationDateAfter = Date() // Date |  (optional)
let valuationDateBefore = Date() // Date |  (optional)

ApiAPI.apiV2PortfoliosList(portfolioUuid: portfolioUuid, client: client, externalCustodianId: externalCustodianId, limit: limit, name: name, offset: offset, ordering: ordering, portfolioType: portfolioType, status: status, valuationDateAfter: valuationDateAfter, valuationDateBefore: valuationDateBefore) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV2PortfoliosPartialUpdate(portfolioUuid: UUID, uuid: UUID, patchedPortfolioUpdate: PatchedPortfolioUpdate? = nil, completion: @escaping (_ data: PortfolioUpdate?, _ error: Error?) -> Void)
```
...
ApiAPI.apiV2PortfoliosPartialUpdate(portfolioUuid: portfolioUuid, uuid: uuid, patchedPortfolioUpdate: patchedPortfolioUpdate) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV2PortfoliosRestrictionsRetrieve(portfolioUuid: UUID, uuid: UUID, completion: @escaping (_ data: PortfolioTypeRestrictions?, _ error: Error?) -> Void)
```
...
ApiAPI.apiV2PortfoliosRestrictionsRetrieve(portfolioUuid: portfolioUuid, uuid: uuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV2PortfoliosRetrieve(portfolioUuid: UUID, uuid: UUID, completion: @escaping (_ data: PortfolioDetail?, _ error: Error?) -> Void)
```
...
ApiAPI.apiV2PortfoliosRetrieve(portfolioUuid: portfolioUuid, uuid: uuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV2PortfoliosUpdate(portfolioUuid: UUID, uuid: UUID, portfolioUpdate: PortfolioUpdate, completion: @escaping (_ data: PortfolioUpdate?, _ error: Error?) -> Void)
```
...
ApiAPI.apiV2PortfoliosUpdate(portfolioUuid: portfolioUuid, uuid: uuid, portfolioUpdate: portfolioUpdate) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
