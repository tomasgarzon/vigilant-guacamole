...
public struct InvestorFee: Codable, Hashable {
    ...
    public init(value: Double? = nil, valueUnit: ValueUnitEnum? = nil, feeType: FeeTypeEnum, concept: String, dateFrom: Date? = nil, dateTo: Date? = nil, amountFrom: Double? = nil, amountTo: Double? = nil, uuid: UUID, created: Date, updated: Date) {
        self.value = value
