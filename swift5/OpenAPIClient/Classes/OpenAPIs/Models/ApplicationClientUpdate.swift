...
public struct ApplicationClientUpdate: Codable, Hashable {
    ...
    public var title: ApplicationClientUpdateTitleOneOf?
    public var firstName: String?
    public var middleName: String?
    public var lastName: String?
    public var gender: ApplicationClientUpdateGenderOneOf?
    public var maritalStatus: ApplicationClientUpdateMaritalStatusOneOf?
    public var phoneNumber: String?
    public var phoneNumberVerified: Date?
    public var language: String
    public var employmentStatus: ApplicationClientUpdateEmploymentStatusOneOf?
    ...
    public init(email: String, birthdate: Date? = nil, tosConsent: Bool? = nil, marketingConsent: Bool? = nil, dataConsent: Bool? = nil, tosConsentDate: Date, taxInformation: [String], countryBirth: CountryField, lastLogin: Date, referredBy: String?, successfulReferrals: Int, kycVerified: Bool, isVerified: Bool, feeSegments: [String], extraData: [String: AnyCodable]? = nil, portfolios: [String], onboardedBy: String? = nil, riskLevel: Int, onboardingToken: String, password: String? = nil, emailVerifiedLastRequest: Date? = nil, uuid: UUID, created: Date, updated: Date, comments: String? = nil, status: StatusB65Enum, emailVerified: Bool? = nil, emailVerifyLastRequest: Date? = nil, title: ApplicationClientUpdateTitleOneOf? = nil, firstName: String? = nil, middleName: String? = nil, lastName: String? = nil, gender: ApplicationClientUpdateGenderOneOf? = nil, maritalStatus: ApplicationClientUpdateMaritalStatusOneOf? = nil, phoneNumber: String? = nil, phoneNumberVerified: Date? = nil, language: String, employmentStatus: ApplicationClientUpdateEmploymentStatusOneOf? = nil, profession: String? = nil, referralCode: String? = nil, activated: Date? = nil, utmSource: String? = nil, utmMedium: String? = nil, utmCampaign: String? = nil, utmTerm: String? = nil, utmContent: String? = nil, marketingConsentDate: Date, dataConsentDate: Date) {
        self.email = email
